...
public class CartDetailConverter {
    public Details convertCartDetailResponseToDetails (CartDetailResponse cartDetailResponse, Orders orders){
        Details details = new Details(cartDetailResponse.getId(), cartDetailResponse.getQuantity(), cartDetailResponse.getImageUrl(), cartDetailResponse.getTitle(), cartDetailResponse.getPrice(), orders);
        return details;
    }
}
